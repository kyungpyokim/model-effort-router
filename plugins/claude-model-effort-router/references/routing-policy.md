...
| `crosses_module_boundary` | yes / no / unknown | Moves responsibilities or contracts between modules, or creates/removes a module boundary (extract, consolidate, isolate, split). Not merely reading, using, or editing code in multiple modules within one boundary |
