...
needs_context -> one repository-aware classifier (Terra Med / Sonnet 5 Med / Gemini 3.1 Pro High),
  skipped when the working directory has no inspectable repository (primary floors stand)
