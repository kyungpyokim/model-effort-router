...
- Preserve the five task types, seven levels (L1~L7) plus critical override, fact-based classifier with `DIFFICULTY_RULES` in `scripts/router.py`, cascading classifier, and code-side security L6 floor unless the user explicitly requests a different policy.
